package com.uga.search_book_service.aspect;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.uga.search_book_service.controller.*.*(..))")
	...
	public void afterReturning(JoinPoint joinPoint, Object result) {
		...
		ResponseEntity<SearchBookResponse> newResult = (ResponseEntity<SearchBookResponse>) result;
