...
public class SearchBook {
	...
	public SearchBook(Long bookId, String title, String isbn, String author, String category, String description,
	...
	public String toString() {
		return "SearchBook [bookId=" + bookId + ", title=" + title + ", isbn=" + isbn + ", author=" + author
				+ ", category=" + category + ", description=" + description + ", cover_picture="
				+ Arrays.toString(cover_picture) + ", publication_year=" + publication_year + ", edition=" + edition
				+ ", publisher=" + publisher + ", book_status=" + book_status + ", quantity_in_stock="
				+ quantity_in_stock + ", minimum_threshold=" + minimum_threshold + ", price=" + price
