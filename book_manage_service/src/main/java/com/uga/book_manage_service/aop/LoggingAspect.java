package com.uga.book_manage_service.aop;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.uga.book_manage_service.controller.*.*(..))")
	...
	public void afterReturning(JoinPoint joinPoint, Object result) {
		...
		ResponseEntity<BookResponse> newResult = (ResponseEntity<BookResponse>) result;
		log.info("{} returned with value {}", joinPoint, newResult.getStatusCode());
	}
