...
public class PaymentStorageController {
	...
	@PostMapping("/deletePaymentDetails/{cardNumber}")
	public ResponseEntity<PaymentDetailsResponse> deletePaymentDetails(@RequestHeader String accountId, @PathVariable String cardNumber) {
		PaymentCard temp = cardRepository.findByCardNumberAndAccountId(cardNumber, accountId);
