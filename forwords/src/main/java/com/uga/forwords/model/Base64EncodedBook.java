...
public class Base64EncodedBook {
	...
	public String toString() {
		return "Base64EncodedBook [book_id=" + book_id + ", title=" + title + ", isbn=" + isbn + ", author=" + author
				+ ", category=" + category + ", description=" + description + ", cover_picture=" + cover_picture
