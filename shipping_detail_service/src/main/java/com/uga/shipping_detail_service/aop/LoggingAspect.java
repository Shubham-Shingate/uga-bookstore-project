package com.uga.shipping_detail_service.aop;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.uga.shipping_detail_service.controller.*.*(..))")
	...
	public void afterReturning(JoinPoint joinPoint, Object result) {
		...
		@SuppressWarnings("unchecked") // result will always be ResponseEntity<ShippingResponse>
		ResponseEntity<ShippingResponse> newResult = (ResponseEntity<ShippingResponse>) result;
